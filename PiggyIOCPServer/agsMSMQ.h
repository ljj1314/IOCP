...
public:
	...
	//add by ljj
	BOOL OpenMQ(CString serv, CString pathmsg,CString labelmsg,CString msg);
	BOOL SendMQ(CString serv, CString pathmsg,CString labelmsg,CString msg);
	BOOL SendMQ(CString serv, CString pathmsg,CString labelmsg,CString msg,unsigned char* msgbuf);
	BOOL CloseMQ(CString serv, CString pathmsg,CString labelmsg,CString msg);
